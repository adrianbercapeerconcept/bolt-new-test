...
import { Mail, Link as LinkIcon, AlertCircle, Users, Info } from 'lucide-react';
...
export function SendInvitation() {
  ...
  const INVITATIONS_LEFT = MAX_INVITATIONS - 2; // Example: User has sent 2 invitations
  ...
  const addEmailField = () => {
    if (emails.length < INVITATIONS_LEFT) {
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-8">
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-8 flex items-start">
        ...
        <div>
          <h3 className="text-sm font-medium text-blue-900">Monthly Invitations</h3>
          <p className="mt-1 text-sm text-blue-700">
            You have {INVITATIONS_LEFT} invitations remaining this month. You can send up to {MAX_INVITATIONS} invitations per month.
          </p>
        </div>
      </div>
        ...
        <div className="p-6">
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <p className="mt-1 text-sm text-gray-500">
                Invite up to {INVITATIONS_LEFT} more connections
              </p>
            </div>
            ...
            <div className="flex items-center justify-between">
              {emails.length < INVITATIONS_LEFT && (
                <button
                  type="button"
